...
function App() {
  ...
  return <main>
    <header>
      <div className="brand"><img src="/assets/terminal-theme-studio-icon-192.png" alt="" /><div><p className="eyebrow">TERMINAL THEME STUDIO</p><h1>Build your own terminal theme.</h1><p className="intro">Your A11y compliant theme, twenty-three exports from Alacritty to Xterm. Everything stays on your device.</p></div></div>
